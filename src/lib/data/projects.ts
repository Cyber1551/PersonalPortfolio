...
export const projects: Project[] = [
	{
		...
		overview: "A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks." +
			"A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.A cross-platform desktop media organizer that deduplicates content via hashing and exposes a tag-based filesystem view using hardlinks.",
	},
	{
